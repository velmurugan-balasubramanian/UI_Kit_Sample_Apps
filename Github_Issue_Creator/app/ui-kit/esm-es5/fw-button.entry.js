...
var Button = /** @class */ (function () {
    ...
    Button.prototype.render = function () {
        var _this = this;
        return (h(Host, { onClick: function () { return _this.handleClick(); }, onFocus: function () { return _this.onFocus(); }, onBlur: function () { return _this.onBlur(); } }, h("button", { type: this.type, class: "\n            fw-btn fw-btn--" + this.color.toLowerCase() + "\n            fw-btn--" + this.size.toLowerCase() + "\n            " + (this.expand ? 'fw-btn--block' : '') + "\n            ", disabled: this.disabled }, h("slot", null))));
    };
