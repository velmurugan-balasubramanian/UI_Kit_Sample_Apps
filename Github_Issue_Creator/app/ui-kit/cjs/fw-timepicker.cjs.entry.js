...
const Timepicker = class {
    ...
    render() {
        return (core.h("fw-select", { onFwChange: this.setTimeValue }, this.timeValues.map(time => core.h("fw-select-option", { value: this.currentTimeValue(time) }, this.currentTimeLabel(time)))));
    }
};
