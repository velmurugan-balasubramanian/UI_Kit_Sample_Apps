...
const SelectOption = class {
    constructor(hostRef) {
         ...
         */
        this.selected = false;
        this.fwSelected = core.createEvent(this, "fwSelected", 7);
    }
    onOptionSelected() {
    ...
    render() {
        return (core.h("li", { class: { 'select-option': true, 'selected': this.selected }, onMouseDown: () => this.onOptionSelected() }, core.h("slot", null)));
    }
...
const Tag = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.fwClosed = core.createEvent(this, "fwClosed", 7);
    }
    removeTag() {
    ...
    render() {
        return (core.h("div", { class: "tag" }, this.text, core.h("span", { role: "button", class: "remove-btn", onClick: () => this.removeTag() }, "\u00D7")));
    }
