...
const Tabs = class {
    ...
    render() {
        return (core.h("div", { class: "tabs" }, core.h("ul", { role: "tablist", class: "tabs__items" }, this.tabs.map((tab, index) => core.h("li", { onClick: event => this.toggelLink(event, index), class: "tabs__item contacts-tab_item text--xsmall text--uppercase ember-view" }, core.h("a", { href: '#tab-' + index, class: 'tabs__item__nav ' + (index === this.activeTabIndex ? 'active' : '') }, core.h("span", { class: "tab-title--tab-icon" }, core.h("span", { class: "tab-title" }, tab.getAttribute('title'))), " ")))), core.h("div", { class: "tabs__content" }, this.tabs.map((tab, index) => core.h("div", { onClick: event => this.toggelLink(event, index), innerHTML: tab.innerHTML, role: "tabpanel", id: 'tab-' + index, class: 'tabs__content__pane tabs__content__pane--fade ' + (index === this.activeTabIndex ? 'in active' : '') + this.activeChildClass })))));
    }
