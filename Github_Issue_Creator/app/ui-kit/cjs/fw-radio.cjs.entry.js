...
const Radio = class {
    constructor(hostRef) {
         ...
         */
        this.name = '';
        this.fwSelect = core.createEvent(this, "fwSelect", 7);
        this.fwDeselect = core.createEvent(this, "fwDeselect", 7);
    ...
    render() {
        return (core.h(core.Host, { class: "radio-container", onClick: () => this.toggle(), role: "radio", tabIndex: "0", "aria-disabled": this.disabled ? 'true' : 'false', "aria-checked": `${this.checked}`, onFocus: () => this.onFocus(), onBlur: () => this.onBlur() }, core.h("input", { type: "radio", ref: el => this.radio = el }), core.h("label", null, core.h("span", { class: "text" }, core.h("slot", null)), core.h("br", null), this.label !== ''
