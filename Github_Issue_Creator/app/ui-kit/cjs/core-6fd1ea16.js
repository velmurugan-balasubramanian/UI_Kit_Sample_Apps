...
const NAMESPACE = 'freshworks-ui-kit';
...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-6fd1ea16.js', document.baseURI).href));
