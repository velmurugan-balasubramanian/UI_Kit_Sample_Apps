...
const Input = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { "aria-disabled": this.disabled, class: {
            ...
            } }, core.h("div", { class: "input-container" }, this.label !== '' ? core.h("label", { class: {
            ...
            } }, core.h("input", { ref: input => this.nativeInput = input, autoComplete: this.autocomplete, disabled: this.disabled, name: this.name, placeholder: this.placeholder || '', minLength: this.minlength, maxLength: this.maxlength, readOnly: this.readonly, required: this.required, type: this.type, value: value, onInput: e => this.onInput(e), onBlur: this.onBlur, onFocus: this.onFocus }), this.iconLeft !== undefined ? core.h("fw-icon", { class: "icon left", name: this.iconLeft }) : '', this.iconRight !== undefined ? core.h("fw-icon", { class: "icon right", name: this.iconRight }) : '', this.clearInput && this.value.length > 0 ?
            core.h("div", { class: "clear-button", onClick: e => this.clearTextInput(e) }, core.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", viewBox: "0 0 32 32", class: "clear-button-img" }, core.h("path", { d: "M17.992 16l8.796-8.796a1.409 1.409 0 0 0-1.992-1.992L16 14.008 7.204 5.212a1.409 1.409 0 0 0-1.992 1.992L14.008 16l-8.796 8.796a1.409 1.409 0 0 0 1.992 1.992L16 17.992l8.796 8.796a1.409 1.409 0 0 0 1.992-1.992L17.992 16z" }))) : ''), this.stateText !== '' ?
